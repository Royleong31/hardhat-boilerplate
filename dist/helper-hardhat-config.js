...
exports.getNetworkIdFromName = exports.developmentChains = exports.networkConfig = void 0;
...
exports.developmentChains = ["hardhat", "localhost", "mainnet-fork"];
const getNetworkIdFromName = async (networkIdName) => {
    for (const id in exports.networkConfig) {
        if (exports.networkConfig[id].name === networkIdName) {
            return id;
        }
    }
    return null;
